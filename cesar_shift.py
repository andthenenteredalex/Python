""" Copyright Alex Clark
    ...
    I'm going to streamline the process. Future developments are to include ways to paste in entire messages and save results as a separate file, or import a file to be encrypted. 
